...
namespace OpenLiveWriter.Api
{
    ...
    public class PluginHttpRequest
    {
        ...
        /// </summary>
        public static bool InternetConnectionAvailable => WinInet.InternetGetConnectedState(out _, 0);
...
#pragma warning restore 612, 618
        ...
        public Stream GetResponse(int timeoutMs)
        {
            ...
            if (this.ReadFromCache
                && WinInet.GetUrlCacheEntryInfo(this.requestUrl, out var cacheInfo)
                && File.Exists(cacheInfo.lpszLocalFileName))
            {
