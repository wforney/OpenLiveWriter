...
namespace OpenLiveWriter.Api
{
    ...
    public class WriterPlugin
    {
        ...
        public virtual void Initialize(IProperties pluginOptions) => this.Options = pluginOptions;
        ...
        public virtual void EditOptions(IWin32Window dialogOwner) => throw new NotImplementedException("WriterPlugin.EditOptions");
