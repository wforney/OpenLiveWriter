...
namespace OpenLiveWriter.ApplicationFramework.ApplicationStyles
{
    ...
    /// <summary>
    /// Class ApplicationStyleSkyBlue.
    /// Implements the <see cref="OpenLiveWriter.ApplicationFramework.ApplicationStyle" />
    /// </summary>
    /// <seealso cref="OpenLiveWriter.ApplicationFramework.ApplicationStyle" />
    public class ApplicationStyleSkyBlue : ApplicationStyle
    {
        ...
        public override Image PreviewImage => ResourceHelper.LoadAssemblyResourceBitmap("ApplicationStyles.Images.SkyBlue.png");
    }
}
